...
static_assert(false||false, "global");
struct A
{
	static const bool value = false||false;
	static_assert(false||false, "class literal");
	static_assert(A::value, "class static");
	A()
	{
		static_assert(false||false, "constructor literal");
...
{
	static const bool value = false||false;
	static_assert(false||false, "template class literal");
	...
	template <typename R>
		B(B<R> &&b)
		{
			static_assert(false||false, "template constructor literal");
...
static void f(B<T> b)
{
	static_assert(false||false, "template function literal");
...
void f(A a)
{
	static_assert(false||false, "function literal");
